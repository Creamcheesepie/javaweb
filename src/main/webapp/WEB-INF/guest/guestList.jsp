...
<p><br/></p>	
				...
				<tr>
					...
					<td class="text-right">
						...
						<c:if test="${pag<totalPage}">
							<a href="${ctp}/GuestList.gu?pageSize=${pageSize}&pag=${pag+1}">▶</a>  
							<a href="${ctp}/GuestList.gu?pageSize=${pageSize}&pag=${totalPage}">▷▷</a>
						</c:if>						
					</td>
				</tr>
			</table>
    ...
    <c:forEach var="i" begin="${curBlock*blockSize + 1}" end="${curBlock*blockSize + blockSize}" varStatus="st">
      ...
      <c:if test="${i <= totalPage && i != pag}">[<font color="red"><a href="${ctp}/GuestList.gu?pageSize=${pageSize}&pag=${i}">${i}</a></font>]</c:if>
    </c:forEach>
