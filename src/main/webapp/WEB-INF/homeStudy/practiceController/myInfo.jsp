...
<div class="container" style="margin-top:30px">
	...
	<div class="row mt-3">
		...
		<div class="col-sm"></div>
		<div class="col-sm">
			<button type="button" class="btn btn-primary" onclick="location.href='${ctp}/hsMain.hs'">홈으로</button>
			<button type="button" class="btn btn-warning" onclick="location.href='${ctp}/hsGoMyInfoChange.hs'">정보수정</button>
		</div>
		<div class="col-sm"></div>	
		<div class="col-sm"></div>
	</div>
