...
<p><br/></p>	
	...
	&nbsp;&nbsp;
	<button type="button" onclick="location.href='${ctp}/ScheduleList.sc';" class="btn btn-secondary btn-sm" title="돌아오기">홈</button>
		...
		<table class="table table-bordered " style="height:450px">
			...
			<tr>
				...
				<c:forEach begin="1" end="${lastDay}" varStatus="st">
					...
					<a href="${ctp}/ScheduleMenu.sc?mid=${sMid}&ymd=${ymd}">${st.count}
					<!-- 해당 날짜에 일정이 있으면 part만을 출력시키기 -->
