...
<p><br/></p>	
	<div class="container">
		...
		<div>
			...
			<input type="button" value="돌아가기" onclick="location.href='${ctp}/SchedulList.sc'" class="btn btn-warning"/>
		</div>
		<div id="demo"></div>
		<hr/>
		...
		<table class="table table-bordered">
			...
			<tr>
				...
				<td>${vo.part}</td>
				<td>
					<input type="button" value="수정" onclick="updateCheck('${vo.idx}','${vo.part}','${vo.content}')" class="btn btn-info"/>
