		...
		<form name="myform" method="post" action="${ctp}/database/joinOk">
			...
			<tr>
				<td colspan="2" class="text-center">
					<input type="submit"  value="회원가입" calss="btn btn-success mt2"/>
					<input type="reset" value="다시 입력"  calss="btn btn-danger "/>
					<input type="button" value="돌아가기" onclick="location.href='${ctp}/study/0428_databse.jsp';" calss="btn btn-warning"/>
				</td>
			</tr>
			</table>
		</form>
